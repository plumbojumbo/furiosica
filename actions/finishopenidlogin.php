...
class FinishopenidloginAction extends Action
{
    ...
    function showContent()
    {
        ...
        $this->input('nickname', _('Existing nickname'), ($sreg['fullname']) ? common_parse_nickname($reg['fullname']) : null);
    ...
    function bestNewNickname($display, $sreg)
    {
        ...
        if ($sreg['fullname']) {
            $fullname = common_parse_nickname($sreg['fullname']);
        ...
        if ($sreg['nickname']) {
            $nickname = common_parse_nickname($sreg['nickname']);
