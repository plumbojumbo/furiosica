...
class TagAction extends Action
{
    ...
    function showFeeds()
    {
        $this->element('link', array('rel' => 'alternate',
                                     'href' => common_local_url('tagrss', common_feed_params(array('tag' => $this->tag))),
    ...
    function showExportData()
    {
        ...
        $fl->show(array(0=>array('href'=>common_local_url('tagrss', common_feed_params(array('tag' => $this->tag))),
                                 'type' => 'rss',
                                 'version' => 'RSS 1.0',
                                 'item' => 'tagrss')));
    }
