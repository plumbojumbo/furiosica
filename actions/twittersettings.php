...
class TwittersettingsAction extends AccountSettingsAction
{
    /**
     * Title of the page
     *
    ...
    {
		$instr = 'Add your Twitter account to automatically send '.
               ' your notices to Twitter, ' .
               'and subscribe to Twitter friends already here.';
		if (common_config('site', 'private')) {
			$instr .= ' Note: Your notices on this site are sent to Twitter only if ' .
					  'you make them public with the #public tag.';
		}
        return _($instr);
    }
