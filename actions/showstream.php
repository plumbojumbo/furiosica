...
class ShowstreamAction extends Action
{
    ...
    function showExportData()
    {
        ...
        $fl->show(array(0=>array('href'=>common_local_url('userrss',
                                                          common_feed_params(array('nickname' => $this->user->nickname))),
                                 'type' => 'rss',
                                 'version' => 'RSS 1.0',
                                 'item' => 'notices'),
         ...
         $this->element('link',
             array('rel' => 'alternate',
                   'href' => common_local_url('api',
                     common_feed_params(array('apiaction' => 'statuses',
    ...
    function showAnonymousMessage()
    {
		$m = _('Hi, das hier ist die Redaktionspinnwand von [FURIOS](http://www.furios-campus.de/), dem ' . 
			   ...
			   'der Redaktion, wir freuen uns aber auf deine Nachrichten bei [Twitter](http://twitter.com/fucampus)!');
