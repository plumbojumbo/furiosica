...
create table notice (
	...
	force_public integer default 0 /* comment 'show notice in public even when site is private' */
...
create table invitation (
     ...
     address_type varchar(8) not null /* comment 'address type ("email", "jabber", "sms") '*/,
     created timestamp not null /* comment 'date this record was created' */,
	 registered_user_id int default 0 /* comment 'user registered with the invitation' */ references "user" (id)
